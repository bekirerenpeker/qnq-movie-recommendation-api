    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryDataMovieData", x => new { x.CategoriesId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_CategoryDataMovieData_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryDataMovieData_Movies_MoviesId",
                        column: x => x.MoviesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryDataMovieData_MoviesId",
                table: "CategoryDataMovieData",
                column: "MoviesId");
